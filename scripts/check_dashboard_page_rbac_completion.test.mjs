...
test('completion gate includes the 0155 Agent dependency and 0161 insight-filter overlays', async () => {
...
test('completion gate rejects structural regressions, not just matching strings', () => {
  ...
  assert.throws(() => validateCompletionFacts({ ...base, catalogOutput: '52 pages, 47 ordinary, 5 superadmin_only, 0 unmapped dashboard API usages' }), /catalog gate/);
