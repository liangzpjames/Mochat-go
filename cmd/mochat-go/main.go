...
func main() {
	...
	if cfg.MigrateChannelCodeIndex || cfg.MigrateChannelCodeShow || cfg.MigrateChannelCodeContact || cfg.MigrateChannelCodeStatistics || cfg.MigrateChannelCodeStatsIndex || cfg.MigrateChannelCodeStore || cfg.MigrateChannelCodeUpdate ||
		...
		log.Printf("go migrated route enabled: GET /dashboard/channelCode/workspaceStatistics")
		log.Printf("go migrated route enabled: GET /dashboard/channelCode/workspaceStatisticsIndex")
		log.Printf("go migrated route enabled: GET /dashboard/channelCode/export")
	...
	if archivePlan.durableWorker {
		...
		log.Printf("INFO durable archive workers enabled: automatic_schedule=%t interval=%s schedule_run_on_start=%v limit=%d storage_root=%s",
