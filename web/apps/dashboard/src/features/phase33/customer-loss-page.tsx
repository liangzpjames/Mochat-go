...
export function CustomerLossPage({ api }: { api: BusinessWorkbenchApi }) {
  ...
  return <section className="phase33-risk-warning-page">
    <header className="phase33-risk-warning-header dashboard-page-header dashboard-data-card"><div><p className="phase33-risk-warning-eyebrow">风险预警</p><h1>客户流失</h1><p>查看当前企业范围内由后端流失客户接口返回的记录。</p></div><button type="button" disabled={!enabled || query.isFetching} onClick={() => void query.refetch()}>刷新</button></header>
