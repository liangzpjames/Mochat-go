...
function filterOptionsPath(prefix: 'session-analysis' | 'smart-analysis', employeeKeyword?: string, limit?: number): string { return `/ai-insight/${prefix}/filter-options?${query({ employeeKeyword, limit })}`; }
