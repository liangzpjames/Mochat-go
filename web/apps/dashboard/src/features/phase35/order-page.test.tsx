...
test('quick creates a real contact and selects it for the order', async () => {
  ...
  fireEvent.change(await screen.findByLabelText('快速联系人姓名'),{target:{value:'新联系人'}});fireEvent.change(screen.getByLabelText('快速联系人手机'),{target:{value:'13800138000'}});fireEvent.click(screen.getByRole('button',{name:'创建并选中'}));
