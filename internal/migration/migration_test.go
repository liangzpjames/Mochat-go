...
func TestStandaloneComposeFreshInitUsesSchemaForCorpDataIndexes(t *testing.T) {
	...
	if latest.Version != "0112_message_intercept_keyword_library_provider" {
		t.Fatalf("latest migration = %q, want 0112_message_intercept_keyword_library_provider", latest.Version)
	}
