...
func TestStandaloneComposeFreshInitUsesSchemaForCorpDataIndexes(t *testing.T) {
	...
	if latest.Version != "0154_dashboard_permission_resource_reconciliation" {
		t.Fatalf("latest migration = %q, want 0154_dashboard_permission_resource_reconciliation", latest.Version)
	}
