...
func TestRegisterRoutesInstallsAllSCRMRoutes(t *testing.T) {
	...
	want := []registeredRoute{
		...
		{method: nethttp.MethodPost, pattern: transporthttp.ContactsPath},
		...
		{method: nethttp.MethodPost, pattern: transporthttp.AcceptancePath},
		{method: nethttp.MethodDelete, pattern: transporthttp.AcceptancePath},
