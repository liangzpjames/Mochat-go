...
func TestCustomerLifecycleRejectsCorpAssertionDifferentFromDashboardPrincipal(t *testing.T) {
...
func TestCustomerTagRejectsCorpAssertionDifferentFromDashboardPrincipal(t *testing.T) {
...
func TestOpportunityRejectsCorpAssertionDifferentFromDashboardPrincipal(t *testing.T) {
...
func TestOrderRejectsCorpAssertionDifferentFromDashboardPrincipal(t *testing.T) {
...
func TestSettingsRejectsCorpAssertionDifferentFromDashboardPrincipal(t *testing.T) {
