...
var diagnosticReasons = map[string]string{
	"wecom.capability_operation_cancelled": "WeCom 能力操作已取消，未形成完成证据",
	"wecom.capability_ready":               "WeCom 能力具有当前凭据版本的成功证据",
	"wecom.employee_sync_ready":            "员工同步具有当前凭据版本的成功证据",
	"wecom.capability_syncing":             "WeCom 能力操作正在执行",
...
var diagnosticActions = map[string]string{
	"wecom.capability_operation_cancelled": "确认目标状态后重新执行 WeCom capability",
	"wecom.capability_ready":               "查看该 WeCom capability 的最近成功结果",
	"wecom.employee_sync_ready":            "查看员工同步结果或按需重新同步",
	"wecom.capability_syncing":             "等待操作完成后查看结果",
