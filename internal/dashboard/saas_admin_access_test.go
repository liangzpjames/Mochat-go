...
func TestSaaSAdminRequiredPermission(t *testing.T) {
	tests := []struct {
		...
		{http.MethodGet, "/dashboard/saasAdmin/tenants/41/wecom-integration", SaaSAdminPermissionIntegrationsRead},
		{http.MethodGet, "/dashboard/saasAdmin/tenants/41/wecom-integration/audits", SaaSAdminPermissionIntegrationsRead},
		{http.MethodPut, "/dashboard/saasAdmin/tenants/41/wecom-integration/candidate", SaaSAdminPermissionIntegrationsManage},
		{http.MethodPost, "/dashboard/saasAdmin/tenants/41/wecom-integration/candidate/verify", SaaSAdminPermissionIntegrationsManage},
		{http.MethodPost, "/dashboard/saasAdmin/tenants/41/wecom-integration/switch", SaaSAdminPermissionIntegrationsManage},
		{http.MethodPost, "/dashboard/saasAdmin/tenants/41/wecom-integration/rollback", SaaSAdminPermissionIntegrationsManage},
