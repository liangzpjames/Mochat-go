...
func (h *RoomMessageBatchSendHandler) resolveAuthorized(w http.ResponseWriter, r *http.Request) (int, User, LoginCorpInfo, bool) {
...
func (h *RoomMessageBatchSendHandler) resolveAccess(w http.ResponseWriter, r *http.Request) (int, User, LoginCorpInfo, bool) {
