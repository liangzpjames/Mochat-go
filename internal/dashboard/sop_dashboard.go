...
func (h *SOPDashboardHandler) ContactIndex(w http.ResponseWriter, r *http.Request) {
	...
	_, _, loginInfo, _, ok := h.resolveAuthorized(w, r, "/dashboard/contactSop/index#get")
	if !ok {
		return
	}
...
func (h *SOPDashboardHandler) ContactInfo(w http.ResponseWriter, r *http.Request) {
	...
	_, _, loginInfo, _, ok := h.resolveAuthorized(w, r, "/dashboard/contactSop/info#get")
	if !ok {
		return
	}
	corpID, ok := selectedCorpID(w, loginInfo)
...
func (h *SOPDashboardHandler) RoomIndex(w http.ResponseWriter, r *http.Request) {
	...
	_, _, loginInfo, _, ok := h.resolveAuthorized(w, r, "/dashboard/roomSop/index#get")
	if !ok {
		return
	}
	corpID, ok := selectedCorpID(w, loginInfo)
...
func (h *SOPDashboardHandler) RoomInfo(w http.ResponseWriter, r *http.Request) {
	...
	_, _, loginInfo, _, ok := h.resolveAuthorized(w, r, "/dashboard/roomSop/info#get")
	if !ok {
		return
	}
	corpID, ok := selectedCorpID(w, loginInfo)
...
func (h *SOPDashboardHandler) resolveAuthorized(w http.ResponseWriter, r *http.Request, permissionKey string) (int, User, LoginCorpInfo, AccessContext, bool) {
...
func (h *SOPDashboardHandler) resolveAccess(w http.ResponseWriter, r *http.Request) (int, User, LoginCorpInfo, bool) {
	if h.resolver == nil {
