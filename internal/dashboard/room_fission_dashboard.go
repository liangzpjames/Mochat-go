...
func (h *RoomFissionHandler) Index(w http.ResponseWriter, r *http.Request) {
	...
	userID, user, _, _, ok := h.resolveAuthorized(w, r, "/dashboard/roomFission/index#get")
	if !ok {
		return
	}
...
func (h *RoomFissionHandler) Store(w http.ResponseWriter, r *http.Request) {
	...
	userID, user, _, _, ok := h.resolveAuthorized(w, r, "/dashboard/roomFission/store#post")
	if !ok {
		return
	}
	corpID, ok := principalCorpID(r)
...
func (h *RoomFissionHandler) Destroy(w http.ResponseWriter, r *http.Request) {
	...
	_, user, _, _, ok := h.resolveAuthorized(w, r, "/dashboard/roomFission/destroy#delete")
	if !ok {
		return
	}
	corpID, ok := principalCorpID(r)
...
func (h *RoomFissionHandler) ShowRoom(w http.ResponseWriter, r *http.Request) {
	...
	_, _, _, _, ok := h.resolveAuthorized(w, r, "/dashboard/roomFission/showRoom#get")
	if !ok {
		return
	}
	corpID, ok := principalCorpID(r)
...
func (h *RoomFissionHandler) ShowContact(w http.ResponseWriter, r *http.Request) {
	...
	_, _, _, _, ok := h.resolveAuthorized(w, r, "/dashboard/roomFission/showContact#get")
	if !ok {
		return
	}
	corpID, ok := principalCorpID(r)
...
func (h *RoomFissionHandler) WriteOff(w http.ResponseWriter, r *http.Request) {
	...
	_, _, _, _, ok := h.resolveAuthorized(w, r, "/dashboard/roomFission/writeOff#get")
	if !ok {
		return
	}
	corpID, ok := principalCorpID(r)
...
func (h *RoomFissionHandler) resolveAuthorized(w http.ResponseWriter, r *http.Request, permissionKey string) (int, User, DashboardRequestScope, AccessContext, bool) {
...
func (h *RoomFissionHandler) resolveAccess(w http.ResponseWriter, r *http.Request) (int, User, DashboardRequestScope, bool) {
	if h.resolver == nil {
