...
func (h *RoomClockInHandler) Index(w http.ResponseWriter, r *http.Request) {
	...
	userID, user, loginInfo, _, ok := h.resolveAuthorized(w, r, "/dashboard/roomClockIn/index#get")
	if !ok {
		return
	}
...
func (h *RoomClockInHandler) Store(w http.ResponseWriter, r *http.Request) {
	...
	userID, user, loginInfo, _, ok := h.resolveAuthorized(w, r, "/dashboard/roomClockIn/store#post")
	if !ok {
		return
	}
	corpID, ok := selectedCorpID(w, loginInfo)
...
func (h *RoomClockInHandler) Destroy(w http.ResponseWriter, r *http.Request) {
	...
	_, user, loginInfo, _, ok := h.resolveAuthorized(w, r, "/dashboard/roomClockIn/destroy#delete")
	if !ok {
		return
	}
	corpID, ok := selectedCorpID(w, loginInfo)
...
func (h *RoomClockInHandler) ShowContact(w http.ResponseWriter, r *http.Request) {
	...
	_, _, loginInfo, _, ok := h.resolveAuthorized(w, r, "/dashboard/roomClockIn/showContact#get")
	if !ok {
		return
	}
	corpID, ok := selectedCorpID(w, loginInfo)
...
func (h *RoomClockInHandler) DayDetail(w http.ResponseWriter, r *http.Request) {
	...
	_, _, loginInfo, _, ok := h.resolveAuthorized(w, r, "/dashboard/roomClockIn/dayDetail#get")
	if !ok {
		return
	}
	corpID, ok := selectedCorpID(w, loginInfo)
...
func (h *RoomClockInHandler) resolveAuthorized(w http.ResponseWriter, r *http.Request, permissionKey string) (int, User, LoginCorpInfo, AccessContext, bool) {
...
func (h *RoomClockInHandler) resolveAccess(w http.ResponseWriter, r *http.Request) (int, User, LoginCorpInfo, bool) {
	if h.resolver == nil {
