...
func (h *RoleAdminHandler) authorize(ctx context.Context, r *http.Request, userID int, loginInfo LoginCorpInfo) (AccessContext, error) {
	if h.authorizer == nil {
...
func selectedCorpID(w http.ResponseWriter, loginInfo LoginCorpInfo) (int, bool) {
