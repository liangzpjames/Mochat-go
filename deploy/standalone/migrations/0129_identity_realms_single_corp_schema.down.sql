...
DROP TABLE IF EXISTS `mochat_go_saas_admin_sessions`;
DROP TABLE IF EXISTS `mochat_go_saas_admin_mfa_challenges`;
DROP TABLE IF EXISTS `mochat_go_saas_admin_mfa_credentials`;
DROP TABLE IF EXISTS `mochat_go_dashboard_password_resets`;
