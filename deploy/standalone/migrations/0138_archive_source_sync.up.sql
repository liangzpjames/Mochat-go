...
SET @archive_audits_invalid := (
  ...
  AND (
    ...
    OR (SELECT COUNT(*) FROM information_schema.statistics WHERE table_schema = DATABASE() AND table_name = 'mochat_go_archive_sync_audits' AND index_name = 'idx_archive_sync_audit_scope' AND non_unique = 1) <> 3
    OR (SELECT COUNT(*) FROM information_schema.statistics WHERE table_schema = DATABASE() AND table_name = 'mochat_go_archive_sync_audits' AND index_name = 'idx_archive_sync_audit_scope' AND non_unique = 1 AND seq_in_index = 1 AND column_name = 'tenant_id') <> 1
    OR (SELECT COUNT(*) FROM information_schema.statistics WHERE table_schema = DATABASE() AND table_name = 'mochat_go_archive_sync_audits' AND index_name = 'idx_archive_sync_audit_scope' AND non_unique = 1 AND seq_in_index = 2 AND column_name = 'corp_id') <> 1
    OR (SELECT COUNT(*) FROM information_schema.statistics WHERE table_schema = DATABASE() AND table_name = 'mochat_go_archive_sync_audits' AND index_name = 'idx_archive_sync_audit_scope' AND non_unique = 1 AND seq_in_index = 3 AND column_name = 'created_at') <> 1
...
SET @archive_sources_invalid := (
  ...
  AND (
    ...
    OR (SELECT COUNT(*) FROM information_schema.statistics WHERE table_schema = DATABASE() AND table_name = 'mochat_go_archive_message_sources' AND index_name = 'uk_archive_message_source_scope_msg' AND non_unique = 0) <> 3
    OR (SELECT COUNT(*) FROM information_schema.statistics WHERE table_schema = DATABASE() AND table_name = 'mochat_go_archive_message_sources' AND index_name = 'uk_archive_message_source_scope_msg' AND non_unique = 0 AND seq_in_index = 1 AND column_name = 'tenant_id') <> 1
    OR (SELECT COUNT(*) FROM information_schema.statistics WHERE table_schema = DATABASE() AND table_name = 'mochat_go_archive_message_sources' AND index_name = 'uk_archive_message_source_scope_msg' AND non_unique = 0 AND seq_in_index = 2 AND column_name = 'corp_id') <> 1
    OR (SELECT COUNT(*) FROM information_schema.statistics WHERE table_schema = DATABASE() AND table_name = 'mochat_go_archive_message_sources' AND index_name = 'uk_archive_message_source_scope_msg' AND non_unique = 0 AND seq_in_index = 3 AND column_name = 'msgid') <> 1
