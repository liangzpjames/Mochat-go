...
SET @wecom_0139_parent_invalid := (
  ...
  OR EXISTS (SELECT 1 FROM information_schema.columns WHERE table_schema = DATABASE() AND table_name = 'mochat_go_tenant_corp_bindings' AND column_name = 'version' AND NOT (data_type = 'bigint' AND numeric_precision = 19 AND column_type LIKE '%unsigned%' AND is_nullable = 'NO'))
...
SET @wecom_0139_binding_generation_invalid := (
  EXISTS (SELECT 1 FROM information_schema.columns WHERE table_schema = DATABASE() AND table_name = 'mochat_go_tenant_corp_bindings' AND column_name IN ('employee_credential_generation','contact_credential_generation','agent_credential_generation','callback_credential_generation') AND NOT (data_type = 'bigint' AND numeric_precision = 19 AND column_type LIKE '%unsigned%' AND is_nullable = 'NO' AND (column_default = '1' OR column_default = '''1''')))
);
...
SET @wecom_0139_operations_invalid := (
  (SELECT COUNT(*) FROM information_schema.tables WHERE table_schema = DATABASE() AND table_name = 'mochat_go_wecom_capability_operations') = 1 AND (
    ...
    OR EXISTS (SELECT 1 FROM information_schema.columns WHERE table_schema = DATABASE() AND table_name = 'mochat_go_wecom_capability_operations' AND ((column_name IN ('id','credential_generation') AND NOT (data_type = 'bigint' AND numeric_precision = 19 AND column_type LIKE '%unsigned%' AND is_nullable = 'NO')) OR (column_name IN ('tenant_id','corp_id','target_total','success_total','failure_total','attempt') AND NOT (data_type = 'int' AND numeric_precision = 10 AND column_type LIKE '%unsigned%' AND is_nullable = 'NO')) OR (column_name IN ('capability','action','idempotency_key','status','provider_request_id','provider_object_id','actual_agent_id','error_code','actor_source','request_id','lease_token') AND NOT (data_type = 'varchar' AND is_nullable = 'NO' AND collation_name = 'utf8mb4_unicode_ci')) OR (column_name IN ('external_success','callback_evidence') AND NOT (data_type = 'tinyint' AND is_nullable = 'NO')) OR (column_name = 'actor_user_id' AND NOT (data_type = 'int' AND numeric_precision = 10 AND column_type LIKE '%unsigned%' AND is_nullable = 'YES')) OR (column_name IN ('lease_expires_at','started_at','finished_at') AND NOT (data_type = 'datetime' AND datetime_precision = 6 AND is_nullable = 'YES')) OR (column_name IN ('requested_at','created_at','updated_at') AND NOT (data_type = 'datetime' AND datetime_precision = 6 AND is_nullable = 'NO'))))
...
SET @wecom_0139_dispatches_invalid := (
  (SELECT COUNT(*) FROM information_schema.tables WHERE table_schema = DATABASE() AND table_name = 'mochat_go_wecom_capability_dispatches') = 1 AND (
    ...
    OR EXISTS (SELECT 1 FROM information_schema.columns WHERE table_schema = DATABASE() AND table_name = 'mochat_go_wecom_capability_dispatches' AND ((column_name IN ('id','operation_id','credential_generation') AND NOT (data_type = 'bigint' AND numeric_precision = 19 AND column_type LIKE '%unsigned%' AND is_nullable = 'NO')) OR (column_name IN ('tenant_id','corp_id','chunk_no','attempt') AND NOT (data_type = 'int' AND numeric_precision = 10 AND column_type LIKE '%unsigned%' AND is_nullable = 'NO')) OR (column_name IN ('dispatch_kind','target_id','idempotency_key','status','provider_request_id','provider_message_id','provider_object_id','lease_token','last_error_code') AND NOT (data_type = 'varchar' AND is_nullable = 'NO' AND collation_name = 'utf8mb4_unicode_ci')) OR (column_name IN ('lease_expires_at','next_poll_at') AND NOT (data_type = 'datetime' AND datetime_precision = 6 AND is_nullable = 'YES')) OR (column_name IN ('created_at','updated_at') AND NOT (data_type = 'datetime' AND datetime_precision = 6 AND is_nullable = 'NO'))))
...
SET @wecom_0139_results_invalid := (
  (SELECT COUNT(*) FROM information_schema.tables WHERE table_schema = DATABASE() AND table_name = 'mochat_go_wecom_capability_operation_results') = 1 AND (
    ...
    OR EXISTS (SELECT 1 FROM information_schema.columns WHERE table_schema = DATABASE() AND table_name = 'mochat_go_wecom_capability_operation_results' AND ((column_name = 'id' AND NOT (data_type = 'bigint' AND numeric_precision = 19 AND column_type LIKE '%unsigned%' AND is_nullable = 'NO')) OR (column_name IN ('tenant_id','corp_id') AND NOT (data_type = 'int' AND numeric_precision = 10 AND column_type LIKE '%unsigned%' AND is_nullable = 'NO')) OR (column_name = 'operation_id' AND NOT (data_type = 'bigint' AND numeric_precision = 19 AND column_type LIKE '%unsigned%' AND is_nullable = 'NO')) OR (column_name IN ('target_kind','target_id','status','provider_target_id','error_code','error_message_safe') AND NOT (data_type = 'varchar' AND is_nullable = 'NO' AND collation_name = 'utf8mb4_unicode_ci')) OR (column_name IN ('created_at','updated_at') AND NOT (data_type = 'datetime' AND datetime_precision = 6 AND is_nullable = 'NO'))))
...
SET @wecom_0139_audits_invalid := (
  (SELECT COUNT(*) FROM information_schema.tables WHERE table_schema = DATABASE() AND table_name = 'mochat_go_wecom_capability_operation_audits') = 1 AND (
    ...
    OR EXISTS (SELECT 1 FROM information_schema.columns WHERE table_schema = DATABASE() AND table_name = 'mochat_go_wecom_capability_operation_audits' AND ((column_name = 'operation_id' AND NOT (data_type = 'bigint' AND numeric_precision = 19 AND column_type LIKE '%unsigned%' AND is_nullable = 'NO')) OR (column_name = 'dispatch_id' AND NOT (data_type = 'bigint' AND numeric_precision = 19 AND column_type LIKE '%unsigned%' AND is_nullable = 'YES')) OR (column_name = 'actor_user_id' AND NOT (data_type = 'int' AND numeric_precision = 10 AND column_type LIKE '%unsigned%' AND is_nullable = 'YES'))))
...
SET @wecom_0139_events_invalid := (
  (SELECT COUNT(*) FROM information_schema.tables WHERE table_schema = DATABASE() AND table_name = 'mochat_go_wecom_capability_operation_events') = 1 AND (
    ...
    OR EXISTS (SELECT 1 FROM information_schema.columns WHERE table_schema = DATABASE() AND table_name = 'mochat_go_wecom_capability_operation_events' AND ((column_name = 'operation_id' AND NOT (data_type = 'bigint' AND numeric_precision = 19 AND column_type LIKE '%unsigned%' AND is_nullable = 'NO')) OR (column_name = 'dispatch_id' AND NOT (data_type = 'bigint' AND numeric_precision = 19 AND column_type LIKE '%unsigned%' AND is_nullable = 'YES')) OR (column_name = 'actor_user_id' AND NOT (data_type = 'int' AND numeric_precision = 10 AND column_type LIKE '%unsigned%' AND is_nullable = 'YES'))))
