...
CREATE TABLE IF NOT EXISTS `mochat_go_archive_media_objects` (
  ...
  `sdk_file_id_ciphertext` longtext COLLATE utf8mb4_bin NOT NULL,
  `sdk_file_id_key_id` varchar(64) COLLATE utf8mb4_bin NOT NULL,
  ...
  `expected_md5` char(32) COLLATE utf8mb4_bin NOT NULL DEFAULT '',
  ...
  `checkpoint_attempt` int(10) unsigned NOT NULL DEFAULT 0,
  `download_finished` tinyint(1) NOT NULL DEFAULT 0,
  `download_sha256` char(64) COLLATE utf8mb4_bin NOT NULL DEFAULT '',
