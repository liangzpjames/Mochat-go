...
-- ----------------------------
-- Table structures for mc_work_message_1 through mc_work_message_10
-- ----------------------------
CREATE TABLE IF NOT EXISTS `mc_work_message_1` (
  ...
  KEY `idx_mc_work_message_1_global_search` (`corp_id`,`work_employee_id`,`deleted_at`,`to_user_type`,`msg_data_time`,`to_user_id`,`seq`)
...
CREATE TABLE IF NOT EXISTS `mc_work_message_2` (
  ...
  `updated_at` timestamp NULL DEFAULT NULL ON UPDATE CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`),
  KEY `idx_mc_work_message_2_corp_employee` (`corp_id`, `work_employee_id`),
  KEY `idx_mc_work_message_2_to_user` (`to_user_type`, `to_user_id`),
  KEY `idx_mc_work_message_2_msg_time` (`msg_data_time`),
  KEY `idx_mc_work_message_2_status` (`status`),
  KEY `idx_mc_work_message_2_global_search` (`corp_id`,`work_employee_id`,`deleted_at`,`to_user_type`,`msg_data_time`,`to_user_id`,`seq`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='会话内容存档分表2';
...
CREATE TABLE IF NOT EXISTS `mc_work_message_3` (
  ...
  `updated_at` timestamp NULL DEFAULT NULL ON UPDATE CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`),
  KEY `idx_mc_work_message_3_corp_employee` (`corp_id`, `work_employee_id`),
  KEY `idx_mc_work_message_3_to_user` (`to_user_type`, `to_user_id`),
  KEY `idx_mc_work_message_3_msg_time` (`msg_data_time`),
  KEY `idx_mc_work_message_3_status` (`status`),
  KEY `idx_mc_work_message_3_global_search` (`corp_id`,`work_employee_id`,`deleted_at`,`to_user_type`,`msg_data_time`,`to_user_id`,`seq`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='会话内容存档分表3';
...
CREATE TABLE IF NOT EXISTS `mc_work_message_4` (
  ...
  `updated_at` timestamp NULL DEFAULT NULL ON UPDATE CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`),
  KEY `idx_mc_work_message_4_corp_employee` (`corp_id`, `work_employee_id`),
  KEY `idx_mc_work_message_4_to_user` (`to_user_type`, `to_user_id`),
  KEY `idx_mc_work_message_4_msg_time` (`msg_data_time`),
  KEY `idx_mc_work_message_4_status` (`status`),
  KEY `idx_mc_work_message_4_global_search` (`corp_id`,`work_employee_id`,`deleted_at`,`to_user_type`,`msg_data_time`,`to_user_id`,`seq`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='会话内容存档分表4';
...
CREATE TABLE IF NOT EXISTS `mc_work_message_5` (
  ...
  `updated_at` timestamp NULL DEFAULT NULL ON UPDATE CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`),
  KEY `idx_mc_work_message_5_corp_employee` (`corp_id`, `work_employee_id`),
  KEY `idx_mc_work_message_5_to_user` (`to_user_type`, `to_user_id`),
  KEY `idx_mc_work_message_5_msg_time` (`msg_data_time`),
  KEY `idx_mc_work_message_5_status` (`status`),
  KEY `idx_mc_work_message_5_global_search` (`corp_id`,`work_employee_id`,`deleted_at`,`to_user_type`,`msg_data_time`,`to_user_id`,`seq`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='会话内容存档分表5';
...
CREATE TABLE IF NOT EXISTS `mc_work_message_6` (
  ...
  `updated_at` timestamp NULL DEFAULT NULL ON UPDATE CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`),
  KEY `idx_mc_work_message_6_corp_employee` (`corp_id`, `work_employee_id`),
  KEY `idx_mc_work_message_6_to_user` (`to_user_type`, `to_user_id`),
  KEY `idx_mc_work_message_6_msg_time` (`msg_data_time`),
  KEY `idx_mc_work_message_6_status` (`status`),
  KEY `idx_mc_work_message_6_global_search` (`corp_id`,`work_employee_id`,`deleted_at`,`to_user_type`,`msg_data_time`,`to_user_id`,`seq`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='会话内容存档分表6';
...
CREATE TABLE IF NOT EXISTS `mc_work_message_7` (
  ...
  `updated_at` timestamp NULL DEFAULT NULL ON UPDATE CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`),
  KEY `idx_mc_work_message_7_corp_employee` (`corp_id`, `work_employee_id`),
  KEY `idx_mc_work_message_7_to_user` (`to_user_type`, `to_user_id`),
  KEY `idx_mc_work_message_7_msg_time` (`msg_data_time`),
  KEY `idx_mc_work_message_7_status` (`status`),
  KEY `idx_mc_work_message_7_global_search` (`corp_id`,`work_employee_id`,`deleted_at`,`to_user_type`,`msg_data_time`,`to_user_id`,`seq`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='会话内容存档分表7';
...
CREATE TABLE IF NOT EXISTS `mc_work_message_8` (
  ...
  `updated_at` timestamp NULL DEFAULT NULL ON UPDATE CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`),
  KEY `idx_mc_work_message_8_corp_employee` (`corp_id`, `work_employee_id`),
  KEY `idx_mc_work_message_8_to_user` (`to_user_type`, `to_user_id`),
  KEY `idx_mc_work_message_8_msg_time` (`msg_data_time`),
  KEY `idx_mc_work_message_8_status` (`status`),
  KEY `idx_mc_work_message_8_global_search` (`corp_id`,`work_employee_id`,`deleted_at`,`to_user_type`,`msg_data_time`,`to_user_id`,`seq`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='会话内容存档分表8';
...
CREATE TABLE IF NOT EXISTS `mc_work_message_9` (
  ...
  `updated_at` timestamp NULL DEFAULT NULL ON UPDATE CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`),
  KEY `idx_mc_work_message_9_corp_employee` (`corp_id`, `work_employee_id`),
  KEY `idx_mc_work_message_9_to_user` (`to_user_type`, `to_user_id`),
  KEY `idx_mc_work_message_9_msg_time` (`msg_data_time`),
  KEY `idx_mc_work_message_9_status` (`status`),
  KEY `idx_mc_work_message_9_global_search` (`corp_id`,`work_employee_id`,`deleted_at`,`to_user_type`,`msg_data_time`,`to_user_id`,`seq`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='会话内容存档分表9';
...
CREATE TABLE IF NOT EXISTS `mc_work_message_10` (
  ...
  `updated_at` timestamp NULL DEFAULT NULL ON UPDATE CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`),
  KEY `idx_mc_work_message_10_corp_employee` (`corp_id`, `work_employee_id`),
  KEY `idx_mc_work_message_10_to_user` (`to_user_type`, `to_user_id`),
  KEY `idx_mc_work_message_10_msg_time` (`msg_data_time`),
  KEY `idx_mc_work_message_10_status` (`status`),
  KEY `idx_mc_work_message_10_global_search` (`corp_id`,`work_employee_id`,`deleted_at`,`to_user_type`,`msg_data_time`,`to_user_id`,`seq`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='会话内容存档分表10';
