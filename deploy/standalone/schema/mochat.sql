...
CREATE TABLE IF NOT EXISTS `mc_work_room_auto_pull` (
  ...
  `qrcode_url` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '' COMMENT '二维码地址',
  `wx_config_id` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '' COMMENT '二维码凭证',
  `provider_kind` varchar(20) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'contact_way' COMMENT '二维码供应商类型',
  `auto_create_room` tinyint(3) unsigned NOT NULL DEFAULT '0' COMMENT '群满后自动建群',
  `room_base_name` varchar(30) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '' COMMENT '自动建群基础名称',
  `room_base_id` int(10) unsigned NOT NULL DEFAULT '1' COMMENT '自动建群起始序号',
